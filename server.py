...
desc = '<a href="https://esaj.tjsp.jus.br/cpopg/open.do">FONTE</a>'

tags_metadata = [
    {
        'name': 'monitoramento-processual-tjsp',
        'description': 'Consulta processual no tribunal de justiça de São Paulo',
    }
]
...
#---------------------------- Application -------------------------------
app = FastAPI(
    title='REST API - Monitoramento processual no tribunal de justiça de São Paulo', 
    description=desc, 
    debug=False, 
    openapi_tags=tags_metadata,
    openapi_url="/api/monitoramento-processual-tjsp/consulta/docs/openapi.json",
    docs_url='/api/monitoramento-processual-tjsp/consulta/docs'
)
...
#---------------------------- Endpoints -------------------------------
@app.get(
    path="/api/monitoramento-processual-tjsp/consulta", 
    tags=['monitoramento-processual-tjsp'])
